# -*- coding: utf-8 -*-
# Script to get all loan headers from credit history report
import sys
import re
...
#    raw_text_file = f"{default_folder}/{partial_file_name}_raw_{timestamp}.txt"
    report_file = f"{default_folder}/{partial_file_name}_all_loans_report_{timestamp}.txt"
